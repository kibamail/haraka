...
class Connection {
    ...
    static setupClient(self) {
        ...
        self.set(
            ...
            "ip",
            ipaddr
                .process(self.client.localAddress || local_addr.address)
                .toString(),
        );
    ...
    set(prop_str, val) {
        ...
        if (prop_str === "remote.ip") {
            ...
            if (this.remote.is_local) {
                ...
                this.set(
                    "remote.is_private",
                    net_utils.is_private_ip(this.remote.ip),
                );
            }
        }
    }
    ...
    rcpt_ok_respond(retval, msg) {
        ...
        const rcpt =
            this.transaction.rcpt_to[this.transaction.rcpt_to.length - 1];
...
\tenvelope-from ${this.transaction.mail_from.format()}`;
    ...
    accumulate_data(line) {
        ...
        if (line.length === 2 && line[0] === 0x2e && line[1] === 0x0a) {
            ...
            this.respond(
                451,
                "Bare line-feed; see http://haraka.github.io/barelf/",
                () => {
                    this.reset_transaction();
                },
            );

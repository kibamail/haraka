...
describe("qfile", () => {
    ...
    describe("parts", () => {
        ...
        it("handles 7", () => {
            const r = this.qfile.parts(
                "1516650518128_1516667073032_8_29538_TkPZWz_1_haraka",
            );
            delete r.age;
            assert.deepEqual(r, {
        ...
        it("punts on 5", () => {
            assert.deepEqual(
                this.qfile.parts("1516650518128_1516667073032_8_29538_TkPZWz"),
                null,
            );
        });
    });
    ...
    describe("hostname", () => {
        ...
        it("hostname, replaces \\ char", () => {
            assert.deepEqual(
                this.qfile.hostname("mt\\a1.exam\\ple.com"),
                "mt\\057a1.exam\\057ple.com",
            );
        });

        it("hostname, replaces _ char", () => {
            assert.deepEqual(
                this.qfile.hostname("mt_a1.exam_ple.com"),
                "mt\\137a1.exam\\137ple.com",
            );
        });
    });
});

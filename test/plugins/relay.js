        ...
        it("relaying", (done) => {
            ...
            this.plugin.dest_domains(
                (rc) => {
                    ...
                    assert.equal(
                        1,
                        this.connection.transaction.results.get("relay").skip
                            .length,
                    );
                    done();
                },
        ...
        it("no config", (done) => {
            this.plugin.dest_domains(
                (rc) => {
                    ...
                    assert.equal(
                        1,
                        this.connection.transaction.results.get("relay").err
                            .length,
                    );
                    done();
                },
        ...
        it("action=undef", (done) => {
            ...
            this.plugin.dest_domains(
                (rc) => {
                    ...
                    assert.equal(
                        1,
                        this.connection.transaction.results.get("relay").fail
                            .length,
                    );
                    done();
                },
        ...
        it("action=continue", (done) => {
            ...
            this.plugin.dest_domains(
                (rc) => {
                    ...
                    assert.equal(
                        1,
                        this.connection.transaction.results.get("relay").pass
                            .length,
                    );
                    done();
                },

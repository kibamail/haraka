...
describe("connection", () => {
    ...
    describe("get_remote", () => {
        ...
        it("valid hostname", () => {
            ...
            assert.equal(
                this.connection.get_remote("host"),
                "a.host.tld [172.16.199.198]",
            );
        });
    ...
    describe("local_info", () => {
        ...
        it("is Haraka/version", () => {
            assert.ok(
                /Haraka\/\d.\d/.test(this.connection.local.info),
    ...
    describe("respond", () => {
        ...
        it("disconnected returns undefined", () => {
            ...
            assert.equal(
                this.connection.respond(200, "your lucky day"),
                undefined,
            );
            assert.equal(
                this.connection.respond(550, "you are jacked"),
                undefined,
            );
        });
        ...
        it("state=command, 200", () => {
            assert.equal(
                this.connection.respond(200, "you may pass Go"),
                "200 you may pass Go\r\n",
            );
        });
        ...
        it("DSN 200", () => {
            assert.equal(
                this.connection.respond(
                    200,
                    DSN.create(200, "you may pass Go"),
                ),

...
exports.get_client = function (mx, callback) {
    const socketArgs = mx.path
        ? { path: mx.path }
        : { port: mx.port, host: mx.exchange, localAddress: mx.bind };
...
//----> $16: TODO: USE A POOL PATTERN TO CREATE AND RELEASE CLIENTS
// REPORT ALL AVAILABLE CONNECTIONS TO REDIS, SO THAT MULTIPLE INSTANCES OF HARAKA CAN SHARE THEM.
// FIND A WAY TO KEEP ENCAPSULATION SO POOL PATTERN CAN BE DEFINED BY AN EXTERNAL PLUGIN
// EXAMPLE: ADD A PLUGIN HOOK THAT WILL BE INVOKED TO GET A NEW CLIENT FOR SMTP CONNECTION.
